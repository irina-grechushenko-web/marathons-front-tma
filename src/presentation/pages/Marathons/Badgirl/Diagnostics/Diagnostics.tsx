...
export const Diagnostics = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.title}>Диагностика</div>
      <div className={styles.card}>
        <p>
          Сейчас мы пройдём быстрый опрос в формате тестирования, а в конце получим результат. 
          Вы можете повторно проходить диагностику, чтобы фиксировать изминения
        </p>
        <p>
